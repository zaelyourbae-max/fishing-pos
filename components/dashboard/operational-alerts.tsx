  ...
  return (
    <section className="flex h-full min-w-0 flex-col rounded-[22px] border border-slate-200 bg-white p-5 shadow-[0_16px_40px_rgba(15,23,42,0.04)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_22px_55px_rgba(15,23,42,0.07)] dark:border-slate-800 dark:bg-slate-950/70">
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="shrink-0 whitespace-nowrap rounded-full bg-slate-100 px-2.5 py-1 text-xs font-bold text-slate-600 dark:bg-slate-800 dark:text-slate-300">
          {alerts.length} alert
        </span>
      </div>
            ...
            >
              ...
              {expanded ? (
                <div className="border-t border-white/70 px-3 pb-3 pt-2 dark:border-slate-800/80">
                  ...
                  <Link
                    href={alert.href}
                    className="mt-3 inline-flex min-h-10 items-center gap-2 rounded-xl bg-white px-3 py-2 text-xs font-bold text-slate-700 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:text-teal-700 active:scale-95 dark:bg-slate-950 dark:text-slate-200 dark:hover:text-teal-200"
                  >
                    {alert.action}
