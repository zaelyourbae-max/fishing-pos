      ...
      <section
        className={
          dark
            ...
            : "rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md dark:border-slate-800 dark:bg-slate-950/70"
        }
      >
        <div className="flex items-start justify-between gap-4">
          ...
          <span
            className={
              dark
                ? "rounded-full bg-amber-500/10 px-3 py-1 text-sm font-bold tabular-nums text-amber-300"
                : "rounded-full bg-amber-50 px-3 py-1 text-sm font-bold tabular-nums text-amber-700 dark:bg-amber-500/10 dark:text-amber-200"
            }
          >
            {total}
          </span>
            ...
            <div
              className={
                dark
                  ...
                  : "rounded-xl border border-dashed border-slate-200 p-5 text-center text-sm text-slate-500 dark:border-slate-800 dark:text-slate-400"
              }
            >
            ...
            <button
              ...
              className={
                dark
                  ...
                  : "flex min-h-16 w-full items-center justify-between gap-3 rounded-xl border border-slate-100 p-3 text-left transition hover:-translate-y-0.5 hover:border-amber-200 hover:bg-amber-50/40 hover:shadow-sm active:scale-[0.99] dark:border-slate-800 dark:hover:border-amber-500/30 dark:hover:bg-amber-500/10"
              }
            >
                  ...
                  <span
                    className={
                      dark
                        ...
                        : "mt-1 block truncate text-xs text-slate-500"
                    }
                  >
              ...
              <span
                className={
                  dark
                    ? "shrink-0 text-right text-xs font-bold text-amber-300"
                    : "shrink-0 text-right text-xs font-bold text-amber-700 dark:text-amber-200"
                }
              >
